...
import com.zxj.router.core.callback.NavigationCallback;
...
public class Postcard extends RouteMeta {
    ...
    public Postcard withIntegerArrayList(@Nullable String
                                                 key, @Nullable ArrayList<Integer> value) {
        mBundle.putIntegerArrayList(key, value);
        return this;
    }

    public Postcard withStringArrayList(@Nullable String
                                                key, @Nullable ArrayList<String> value) {
    ...
    public Object navigation(Activity activity, int requestCode, NavigationCallback callback) {
        return MyRouter.getInstance().navigation(activity, this, requestCode, callback);
    }
}
