package com.zxj.router.compiler.utils;

import com.squareup.javapoet.ClassName;

public class Constant {
    public static final ClassName ROUTER = ClassName.get("com.zxj.router.core", "MyRouter");

    public static final String ARGUMENTS_NAME = "moduleName";
    public static final String ANN_TYPE_ROUTE = "com.zxj.router.annotation.Route";
    public static final String ANN_TYPE_Extra = "com.zxj.router.annotation.Extra";


    public static final String IROUTE_GROUP = "com.zxj.router.core.template.IRouteGroup";
    public static final String IROUTE_ROOT = "com.zxj.router.core.template.IRouteRoot";
    public static final String IEXTRA = "com.zxj.router.core.template.IExtra";

    public static final String METHOD_LOAD_INTO = "loadInto";
    public static final String METHOD_LOAD_EXTRA = "loadExtra";

    public static final String ACTIVITY = "android.app.Activity";
    public static final String ISERVICE = "com.zxj.router.core.template.IService";
    ...
    public static final String PACKAGE_OF_GENERATE_FILE = "com.zxj.router.routes";
}
